...
/**
 * Base Settings class.
 * Add the appropriate suffix constant for every field ID to take advantage of the standardized sanitizer.
 *
 * @since      1.0.0
 *
 * @package    AL_Inpsyde
...
abstract class SettingsBase
{
     ...
     * @return //If the string ends with the another string return true, otherwise false
     */
